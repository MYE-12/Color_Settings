...
class ColorSettings(Document):
    ...
    def validate(self):
        ...
        frappe.errprint(logo)

        if frappe.db.exists("DocType", "Navbar Settings") and self.application_logo:
            frappe.db.set_value(
                "Navbar Settings", "Navbar Settings", "app_logo", self.application_logo)
            frappe.db.set_value(
                "Website Settings", "Website Settings", "app_logo", self.favicon_logo)
            frappe.db.set_value(
                "Website Settings", "Website Settings", "splash_image", self.favicon_logo)
            frappe.db.set_value(
                "Website Settings", "Website Settings", "favicon", self.favicon_logo)
        ...
        if self.app_logo_set and not self.application_logo:
            frappe.db.set_value("Navbar Settings",
        ...
        if not self.application_logo:
            ...
            frappe.db.set_value("Navbar Settings",
                                "Navbar Settings", "app_logo", app_logo)
            update_site_config("app_logo_url", False)
            frappe.clear_cache()
        ...
        if not self.favicon_logo:
            ...
            frappe.db.set_value("Website Settings",
                                "Website Settings", "favicon", app_logo_f)
            frappe.db.set_value("Website Settings",
                                "Website Settings", "splash_image", app_logo_f)
            frappe.db.set_value("Website Settings",
                                "Website Settings", "app_logo", app_logo_f)
